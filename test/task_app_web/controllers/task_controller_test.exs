defmodule TaskAppWeb.TaskControllerTest do
  ...
  @create_attrs %{copleted: true, description: "some description"}
  @update_attrs %{copleted: false, description: "some updated description"}
  @invalid_attrs %{copleted: nil, description: nil}
